...
{
    public class AdvanceRequisitionCategoryRepository : BaseRepository<AdvanceCategory>, IAdvanceRequisitionCategoryRepository, IDisposable
    {
        public AdvanceRequisitionCategoryRepository()

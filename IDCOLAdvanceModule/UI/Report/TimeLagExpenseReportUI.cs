...
{
    public partial class TimeLagExpenseReportUI : Form
    {
        ...
        private readonly IAdvance_VW_GetTimeLagForExpenseManager _advanceVwGetTimeLagForExpenseManager;

        public TimeLagExpenseReportUI()
        {
            InitializeComponent();
            ...
            _advanceVwGetTimeLagForExpenseManager = new AdvanceVwGetTimeLagForExpenseManager();
        }
        ...
        private void TimeLagExpenseReportUI_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void showButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                criteria.ExpenseNo = !string.IsNullOrEmpty(expenseNoTextBox.Text) ? expenseNoTextBox.Text : null;
                ...
                string category = Convert.ToInt64(categoryComboBox.SelectedValue) != DefaultItem.Value
                    ...
                    : "N/A";
                string expenseNo = !string.IsNullOrEmpty(expenseNoTextBox.Text)
                    ? expenseNoTextBox.Text
                    : "N/A";
                ...
                ICollection<Advance_VW_GetTimeLagForExpense> reportData =
                    _advanceVwGetTimeLagForExpenseManager.GetByCriteria(criteria);
                ...
                ReportParameter expenseNoParameter = new ReportParameter("ExpenseNo", expenseNo);
                ...
                ReportDataSource ds = new ReportDataSource("DS_TimeLagExpense", reportData);
                timeLagReportViewer.ProcessingMode = ProcessingMode.Local;
                timeLagReportViewer.LocalReport.ReportEmbeddedResource = @"IDCOLAdvanceModule.Rdlc.TimeLagExpenseReport.rdlc";
                ...
                timeLagReportViewer.LocalReport.SetParameters(expenseNoParameter);

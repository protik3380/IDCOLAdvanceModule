namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class SQLVIEW_Advance_VW_GetAdvanceRequisition : DbMigration
    {
        public override void Up()
        {
            Sql(@"CREATE VIEW [dbo].[Advance_VW_GetAdvanceRequisition]
                AS
                SELECT NEWID() as Id,
        ...
        public override void Down()
        {
            Sql(@"IF EXISTS(SELECT 1 FROM sys.views
                    WHERE Name = 'Advance_VW_GetAdvanceRequisition')
                    DROP VIEW Advance_VW_GetAdvanceRequisition");
        }
    }
}

namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class ALTER_Advance_VW_GetPendingExpenseReport_ExpenseAmountInBDT_Fixed : DbMigration
    {
        public override void Up()
        {
            Sql(@"ALTER VIEW [dbo].[Advance_VW_GetPendingExpenseReport]

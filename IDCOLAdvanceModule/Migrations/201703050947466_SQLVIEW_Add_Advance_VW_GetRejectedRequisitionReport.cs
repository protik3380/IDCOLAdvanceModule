namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class SQLVIEW_Add_Advance_VW_GetRejectedRequisitionReport : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"CREATE VIEW [dbo].[Advance_VW_GetRejectedExpenseReport]
            ...
            Sql(@"CREATE VIEW [dbo].[Advance_VW_GetRejectedRequisitionReport]
        ...
        public override void Down()
        {
            ...
            Sql(@"IF EXISTS(SELECT 1 FROM sys.views
                    WHERE Name = 'Advance_VW_GetRejectedExpenseReport')
                    DROP VIEW Advance_VW_GetRejectedExpenseReport");
           
            Sql(@"IF EXISTS(SELECT 1 FROM sys.views
                    WHERE Name = 'Advance_VW_GetRejectedRequisitionReport')
                    DROP VIEW Advance_VW_GetRejectedRequisitionReport");
        }
    }
}

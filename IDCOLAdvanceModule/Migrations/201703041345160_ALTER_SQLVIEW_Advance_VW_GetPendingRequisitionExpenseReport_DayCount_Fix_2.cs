namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class ALTER_SQLVIEW_Advance_VW_GetPendingRequisitionExpenseReport_DayCount_Fix_2 : DbMigration
    {
        public override void Up()
        {
            Sql(@"ALTER VIEW [dbo].[Advance_VW_GetPendingRequisitionExpenseReport]
					...
					ISNULL((DATEDIFF(DAY,reqHeader.RequisitionDate,GETDATE())-IDCOLMIS.dbo.GetWeeklyHolidaysCount(reqHeader.RequisitionDate,GETDATE())),0) as RequisitionDaysCount,
        ...
        public override void Down()
        {
            Sql(@"ALTER VIEW [dbo].[Advance_VW_GetPendingRequisitionExpenseReport]
					...
					ISNULL((DATEDIFF(DAY,ticket.AuthorizedOn,GETDATE())-IDCOLMIS.dbo.GetWeeklyHolidaysCount(ticket.AuthorizedOn,GETDATE())),0) as RequisitionDaysCount,
					ISNULL((DATEDIFF(DAY,expenseTicket.AuthorizedOn,GETDATE())-IDCOLMIS.dbo.GetWeeklyHolidaysCount(expenseTicket.AuthorizedOn,GETDATE())),0) as ExpenseDaysCount

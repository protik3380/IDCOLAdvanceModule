namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class Drop_Advance_VW_GetPendingRequisitionExpenseReport : DbMigration
    {
        public override void Up()
        {
            Sql(@"IF EXISTS(SELECT 1 FROM sys.views
                    WHERE Name = 'Advance_VW_GetPendingRequisitionExpenseReport')
                    DROP VIEW Advance_VW_GetPendingRequisitionExpenseReport");
        }
        
        public override void Down()
        {
            Sql(@"CREATE VIEW [dbo].[Advance_VW_GetPendingRequisitionExpenseReport]

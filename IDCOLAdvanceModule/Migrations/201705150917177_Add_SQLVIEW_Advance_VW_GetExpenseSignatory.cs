namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class Add_SQLVIEW_Advance_VW_GetExpenseSignatory : DbMigration
    {
        public override void Up()
        {
            Sql(@"CREATE VIEW Advance_VW_GetExpenseSignatory
                AS
                SELECT NEWID() AS Id,
                header.Id ExpenseId,
                ...
                JOIN AdvanceExpenseHeader header
                ON header.Id = ticket.AdvanceExpenseHeaderId

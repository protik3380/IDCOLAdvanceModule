namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class ALTER_SP_GetLocalTravelReport_Department : DbMigration
    {
        public override void Up()
        {
            Sql(@"ALTER PROC [dbo].[Advance_SP_GetLocalTravelReport]
                AS
				IF 1=0 BEGIN
				SET FMTONLY OFF
				END
				...
				LEFT OUTER JOIN IDCOLMIS.dbo.Admin_Departments department ON department.DepartmentID = employee.DepartmentID
        ...
        {
            Sql(@"ALTER PROC Advance_SP_GetLocalTravelReport
                AS
                CREATE TABLE #RequisitionInfo
                (
	                RequisitionId bigint,

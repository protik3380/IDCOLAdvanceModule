namespace IDCOLAdvanceModule.Migrations
{
    ...
    public partial class ALTER_Advance_VW_GetRejectedRequisitionReport_AdvanceAmountInBDT_Fixed : DbMigration
    {
        public override void Up()
        {
            Sql(@"ALTER VIEW [dbo].[Advance_VW_GetRejectedRequisitionReport]
